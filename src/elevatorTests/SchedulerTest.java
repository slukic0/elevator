...
public class SchedulerTest {
	...
	public static HashMap<Integer, Deque<Integer>> elevatorQueueMap;
	...
	public void testFindClosestElevator() throws SocketException{ 
		...
		elevatorQueueMap = new HashMap<Integer, Deque<Integer>>();
		int closestElevator = 0;

		// Check if function grabs the closest IDLE elevator
		elevatorMap.put(1, new ElevatorStatus(null, 0, new ElevatorData(ElevatorStates.ARRIVED, 5, 5, null, 1)));
		...
		elevatorQueueMap.put(1, new ArrayDeque<>(new ArrayList<>(Arrays.asList(5))) );
		elevatorQueueMap.put(2, new ArrayDeque<>(new ArrayList<>(Arrays.asList(5))));
		scheduler.setElevatorQueueMap(elevatorQueueMap); 
